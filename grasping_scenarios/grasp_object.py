...
class PickAndPlaceStateMachine(object):
    ...
    def _standby_start(self, *args):
        ...
        self.set_target_to_object(offset_position=[0.0, 0.0, -2.0], n_waypoints=2, clear_waypoints=False)
        # start arm movement
        self.move_to_target()
        # Move to next state
    ...
    def _picking_no_event(self, *args):
        ...
        """
        self.set_target_to_object(offset_position=[0.0, 0.0, -2.0], n_waypoints=1, clear_waypoints=True)
        self.move_to_target()
